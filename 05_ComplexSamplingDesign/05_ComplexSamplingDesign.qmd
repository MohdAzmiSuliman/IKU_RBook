...
::: {.callout-important}
dosm github link to download the map dataset: https://raw.githubusercontent.com/dosm-malaysia/data-open/main/datasets
/geodata/administrative_1_state.geojson
...
4. Join both prevalence by state result and dosm state map.
...
5. we can then plot the prevalence using ggplot
...
```{r}
library(arrow)
dosmpop19 <- read_parquet("https://storage.dosm.gov.my/population/population_malaysia.parquet") %>% 
